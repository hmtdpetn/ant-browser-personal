...
func (a *App) backupClearBusinessTables() error {
	...
	tables := []string{"launch_codes", "browser_profiles", "browser_proxies", "browser_proxy_groups", "browser_cores", "browser_bookmarks", "browser_groups", "browser_extensions", "browser_profile_extension_settings", "browser_profile_extensions"}
